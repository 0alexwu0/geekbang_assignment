...
import java0.nio01.router.TestHttpRouter;
import okhttp3.Call;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    private TestHttpRouter testHttpRouter = new TestHttpRouter();
...
//            value = reponse....
            ...
            //调用指定地址
            String url = testHttpRouter.route(fullRequest.headers().get("goto"));
