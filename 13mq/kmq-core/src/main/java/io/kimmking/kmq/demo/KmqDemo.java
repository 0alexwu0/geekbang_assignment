...
public class KmqDemo {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            while (flag[0]) {
                JSONArray message = consumer.poll(new KmqMessage(null,null,0,1));
                if(null != message) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            producer.send(topic, new KmqMessage(null, order,0,0));
        }
        Thread.sleep(500);
        ...
        while (true) {
            ...
            if(c > 20) {
                ...
                producer.send(topic, new KmqMessage(null, new Order(100000L + c, System.currentTimeMillis(), "USD2CNY", 6.52d),0,0));
            }
